...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var modalTimer = setTimeout(function () {
    Object(_modules_modals__WEBPACK_IMPORTED_MODULE_4__["openModal"])('[data-modal="modal"]', modalTimer);
  }, 20000);
  ...
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_4__["default"])('[data-modal="btn"]', '[data-modal="modal"]', modalTimer);
  ...
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_6__["default"])('.tabheader__item', '.tabcontent', 'active');
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_7__["default"])('.timer', '2022-10-27');
});
...
function cards() {
  ...
  var MenuCard = /*#__PURE__*/function () {
    function MenuCard(imageSrc, imageAlt, cardTitle, cardDesrc, price, parentSelector) {
    ...
    _createClass(MenuCard, [{
      ...
      value: function renderCard() {
        var card = document.createElement('div'); // added all classes from rest operator or add default class
        ...
        card.innerHTML = "\n                <img src=\"".concat(this.imageSrc, "\" alt=\"").concat(this.imageAlt, "\">\n                <h3 class=\"menu__item-subtitle\">").concat(this.cardTitle, "</h3>\n                <div class=\"menu__item-descr\">").concat(this.cardDesrc, "</div>\n                <div class=\"menu__item-divider\"></div>\n                <div class=\"menu__item-price\">\n                    <div class=\"menu__item-cost\">\u0426\u0435\u043D\u0430:</div>\n                    <div class=\"menu__item-total\"><span>").concat(this.price, "</div>\n                </div>\n            "); // append new card
  ...
  Object(_services_services__WEBPACK_IMPORTED_MODULE_5__["getMenuData"])('http://localhost:3000/menu').then(function (data) {
...
function forms(formSelector, modalTimer) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (e) {
      e.preventDefault();
      _modals__WEBPACK_IMPORTED_MODULE_8__["modalSpinner"].style.display = 'block'; // send formData

      var formData = new FormData(form); // json from formData - loop
      ...
      var objectEntries = JSON.stringify(Object.fromEntries(formData.entries()));
      Object(_services_services__WEBPACK_IMPORTED_MODULE_9__["postData"])('http://localhost:3000/requests', objectLoop).then(function () {
        showThanksModal(message.success);
      }).catch(function () {
        showThanksModal(message.failure);
      }).finally(function () {
        form.reset();
        _modals__WEBPACK_IMPORTED_MODULE_8__["modalSpinner"].style.display = 'none';
      });
    });
  }
  ...
  function showThanksModal(message) {
    ...
    Object(_modals__WEBPACK_IMPORTED_MODULE_8__["openModal"])('[data-modal="modal"]', modalTimer);
    ...
    setTimeout(function () {
      thanksModal.remove();
      Object(_modals__WEBPACK_IMPORTED_MODULE_8__["closeModal"])('[data-modal="modal"]');
...
var modalSpinner = document.querySelector('[data-modal="spinner"]');

function modals(triggerSelector, modalSelector, modalTimer) {
  // modal variables
  var modal = document.querySelector(modalSelector);
  var modalBtn = document.querySelectorAll(triggerSelector); // modal listeners
...
function slider(_ref) {
  ...
  var sliderTrack = document.querySelector(track);
  var sliderWrapper = document.querySelector(wrapper);
  var slides = slider.querySelectorAll(slide);
  var btnNext = slider.querySelector(nextArrow);
  var btnPrev = slider.querySelector(prevArrow);
  var indicatorCurrent = slider.querySelector(current);
  var indicatorTotal = slider.querySelector(total);
  var slideIndex = 1;
  var sliderOffset = 0;
  var sliderWidth = window.getComputedStyle(sliderWrapper).width; // slider on transform

  sliderTrack.style.cssText = "width: ".concat(100 * slides.length, "%; display: flex; transition: 0.5s all;");
  ...
  if (slides.length > 10) {
    ...
    indicatorTotal.textContent = "0".concat(slides.length);
  }
  ...
  slider.addEventListener('click', function (e) {
    var target = e.target;
    var currentOffset = +sliderWidth.replace(/\D/gi, '');
    ...
    if (target && target.hasAttribute('data-slide')) {
      var slideTo = target.getAttribute('data-slide');
      slideIndex = slideTo;
  ...
  function moveSlider(sliderOffset) {
    sliderTrack.style.transform = "translateX(-".concat(sliderOffset, "px)");
  }
  ...
  function changeSliderIndicator() {
    if (slides.length > 10) {
      ...
      indicatorCurrent.textContent = "0".concat(slideIndex);
    }
  }
}
...
function tabs(tabBtnSelector, tabContentSelector, activeClass) {
  // tabs variables
  var tabBtn = document.querySelectorAll(tabBtnSelector);
  var tabContent = document.querySelectorAll(tabContentSelector); // tabs listeners

  tabBtn.forEach(function (btn, i) {
    btn.addEventListener('click', function () {
...
function timer(timerSelector, deadlineDate) {
  ...
  var date = new Date(deadlineDate); // add expiring date to markup

  document.querySelector('[data-date="date"]').textContent = "".concat(date.getDate(), ".").concat(date.getMonth() + 1, ".").concat(date.getFullYear());

  function getTimeRemaining(endOfTime) {
    var days, hours, minutes, seconds;
    var t = Date.parse(endOfTime) - new Date(); // difference in ms
  ...
  function setClock(selector, endOfTime) {
    var timer = document.querySelector(selector); // select timer and its parts
    ...
    var timeInterval = setInterval(updateClock, 1000); // call updateClock() every second

    function updateClock() {
      // update variables with data from object that was returned
      var t = getTimeRemaining(endOfTime); // use addZero() to add zero when needed
...
function getMenuData(_x3) {
  return _getMenuData.apply(this, arguments);
}

function _getMenuData() {
  _getMenuData = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(url) {
    var res;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            throw new Error("\u043D\u0435 \u0441\u043C\u043E\u0433 \u0437\u0430\u0444\u0435\u0442\u0447\u0438\u0442\u044C ".concat(url, ", \u0441\u0442\u0430\u0442\u0443\u0441: ").concat(res.status));
