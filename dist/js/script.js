...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const modalTimer = setTimeout(() => {
    Object(_modules_modals__WEBPACK_IMPORTED_MODULE_3__["openModal"])('[data-modal="modal"]', modalTimer);
  }, 20000);
  ...
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_3__["default"])('[data-modal="btn"]', '[data-modal="modal"]', modalTimer);
  ...
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_5__["default"])('.tabheader__item', '.tabcontent', 'active');
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])('.timer', '2022-10-27');
});
...
function cards() {
  ...
  Object(_services_services__WEBPACK_IMPORTED_MODULE_0__["getMenuData"])('http://localhost:3000/menu').then(data => {
    data.forEach(({
      img,
      altimg,
      title,
...
function forms(formSelector, modalTimer) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', e => {
      e.preventDefault();
      _modals__WEBPACK_IMPORTED_MODULE_2__["modalSpinner"].style.display = 'block'; // send formData

      const formData = new FormData(form); // json from formData - loop
      ...
      Object(_services_services__WEBPACK_IMPORTED_MODULE_3__["postData"])('http://localhost:3000/requests', objectLoop).then(() => {
        showThanksModal(message.success);
      }).catch(() => {
        showThanksModal(message.failure);
      }).finally(() => {
        form.reset();
        _modals__WEBPACK_IMPORTED_MODULE_2__["modalSpinner"].style.display = 'none';
      });
    });
  }
  ...
  function showThanksModal(message) {
    ...
    Object(_modals__WEBPACK_IMPORTED_MODULE_2__["openModal"])('[data-modal="modal"]', modalTimer);
    ...
    setTimeout(() => {
      thanksModal.remove();
      Object(_modals__WEBPACK_IMPORTED_MODULE_2__["closeModal"])('[data-modal="modal"]');
...
/*!**********************************!*\
  !*** ./src/js/modules/modals.js ***!
  \**********************************/
/*! exports provided: default, closeModal, openModal, modalSpinner */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "modalSpinner", function() { return modalSpinner; });
...
function modals(triggerSelector, modalSelector, modalTimer) {
  // modal variables
  const modal = document.querySelector(modalSelector);
  const modalBtn = document.querySelectorAll(triggerSelector); // modal listeners
...
function slider({
  ...
  let slideIndex = 1;
  let sliderOffset = 0;
  const sliderWidth = window.getComputedStyle(sliderWrapper).width; // slider on transform
...
function tabs(tabBtnSelector, tabContentSelector, activeClass) {
  ...
  const tabContent = document.querySelectorAll(tabContentSelector); // tabs listeners
...
/*!*************************************!*\
  !*** ./src/js/services/services.js ***!
  \*************************************/
/*! exports provided: postData, getMenuData */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
